...
class DisplayBlogPostsForACategoryController extends BaseFrontendController
{
    ...
    public function DisplayBlogPostsForACategory($categoryTitle)
    {
        ...
        if (!isset($this->messages)) {
            ...
            return view(config('lasallesoftware-libraryfrontend.lasalle_path_to_front_end_view_path') . '.blog.pages.allblogposts', [
                ...
                'prev_page_url'       => $this->getPageURLForPagination('category/'.$categoryTitle, $body->prev_page_url),
                'next_page_url'       => $this->getPageURLForPagination('category/'.$categoryTitle, $body->next_page_url),
