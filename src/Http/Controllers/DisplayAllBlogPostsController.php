...
class DisplayAllBlogPostsController extends CommonControllerForClients
{
    ...
    public function DisplayAllBlogPosts()
    {
        ...
        $path = $this->getApiPath('allblogposts');
        ...
        if (!isset($this->messages)) {
            ...
            return view(config('lasallesoftware-frontendapp.lasalle_path_to_front_end_view_path') . '.blog.pages.allblogposts', [
                ...
                'prev_page_url'                        => $this->getPageURLForPagination($body->prev_page_url, 'blog/all'),
                'next_page_url'                        => $this->getPageURLForPagination($body->next_page_url, 'blog/all'),
